...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {-11, -13, -15}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {16, 18, 20}; // Ports, the first number will be used for sensing
...
const float RATIO     = 1.667; // External drive ratio (MUST BE DECIMAL)
...
#define RIGHT_JOYSTICK pros::E_CONTROLLER_ANALOG_RIGHT_X
//*/

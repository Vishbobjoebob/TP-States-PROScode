...
void neutralMogoAuton() {
  ...
  chassis.wait_drive();
  chassis.set_turn_pid(-33, 110);
  chassis.wait_drive();
  chassis.set_drive_pid( 64, 110, true);
  chassis.wait_drive();
  clampDown();
  pros::delay(100);
  one_mogo_constants();
  chassis.set_drive_pid(-46, 110, true);
  arm.move_absolute(115, 100);
  chassis.wait_drive();
  ...
  tilterUp();
  two_mogo_constants();
  chassis.set_drive_pid(110, 110, true);
  conveyor.move_absolute(-100,50);
  chassis.wait_drive();
  chassis.set_swing_pid(ez::LEFT_SWING, -135, 110);
  conveyor.move_velocity(600);
  chassis.wait_drive();
